...
<?php
    ...
    include("./pages/categories/project/functions/add_category.php");
	include("./pages/categories/project/functions/get_values.php");
	...
	<div class="main-container">
		<div class="pd-ltr-20 height-100-p xs-pd-20-10">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
	            <div class="clearfix">
	            	<div class="pull-left">
	            		<h4 class="text-blue">Project Category</h4>
	            	</div>
	            </div>
                <?php 
                    echo $ErrorMessage_show;
                    include("./pages/categories/project/form.php");
                    include("./pages/categories/project/categories.php");
                ?>
            </div>    
			<?php 
                // Footer
    ...
    function deleteCategory(categoryID){
        ...
        Swal.fire({
            ...
            if (categoryID != "" && categoryID > 0 && dismiss.value) {
				// OKAY
				$.ajax ({
            		url: "./admin/pages/categories/project/functions/delete_category.php",
            		method: "POST",
    ...
    function updateCategory(categoryID){
        ...
        Swal.fire({
          ...
          preConfirm: function (categoryName) {
                ...
                $.ajax ({
            		url: "./admin/pages/categories/project/functions/update_category.php",
            		method: "POST",
