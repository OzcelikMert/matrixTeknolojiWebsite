<form method="post" style="margin-top: 10px;" id="ProjectForm">
	<div class="form-group">
		<label>Title</label>
		<input class="form-control" type="text" maxlength="50" name="title" placeholder="Project Title" value="<?php echo $_POST["title"]; ?>">
	</div>
	<div class="form-group">
		<label>Content</label>
        ...
        <div class="row" id="projectOption">
			<div class="col-md-6 col-sm-12">
				...
				<div class="custom-file">
					<input type="hidden" name="project_logo" id="project_logo" value="<?php echo $_POST["project_logo"]; ?>">
					<input type="file" class="custom-file-input" id="customFile">
					<label class="custom-file-label" id="selectedImageName">Image Name: <?php echo $_POST["project_logo"]; ?></label>
				</div>
			</div>
			<div class="col-md-6 col-sm-12">
    ...
    <div class="form-group">
		<div class="custom-control custom-checkbox">
	    	...
	    	<label class="custom-control-label" for="shareEmails">Share new project with followers</label>
	    </div>
	</div>
    <div class="form-group">
        <div class="custom-control custom-checkbox">
