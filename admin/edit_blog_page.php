...
<?php
    ...
    include("./pages/blog/edit_blog_page/functions/get_values.php");
    include("./pages/blog/edit_blog_page/functions/update_blog.php");
		...
		<div class="pd-ltr-20 height-100-p xs-pd-20-10">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                ...
                <?php 
                    ...
                    include("./pages/blog/edit_blog_page/form.php");
                    include("./pages/blog/add_blog/cropper.php");
                ?>
            </div>    
...
<script>
    ...
    function uploadImage(image) {
        ...
        $.ajax({
            url: './admin/pages/blog/add_blog/functions/upload-image.php',
            cache: false,
            contentType: false,
            processData: false,
            data: data,
        ...
        /*function deleteImage(image) {
            $.ajax({
                url: './admin/pages/blog/add_blog/functions/delete-image.php',
                type: "post",
                data: { image: image},
...
<script>
    ...
    function UploadFile(MyBase64) {
        ...
        $.ajax({
            url:"./admin/pages/blog/add_blog/functions/upload-logo.php",
            data: fd,
            type:"POST",
            contentType:false,
            processData:false,
            ...
            success: function(data){
                if (data != "Error") {
                    ...
                    $("#createBlog").attr("disabled", false);
                }
            }
        });
    }
