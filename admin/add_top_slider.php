...
<?php
    ...
    include("./pages/top_slider/add_top_slider/functions/add_slider.php");
	...
	<div class="main-container">
		<div class="pd-ltr-20 height-100-p xs-pd-20-10">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
	            <div class="clearfix">
	            	<div class="pull-left">
	            		<h4 class="text-blue">Add Top Slider</h4>
	            	</div>
	            </div>
                <?php 
                    echo $ErrorMessage_show;
                    include("./pages/top_slider/add_top_slider/form.php");
                ?>
            </div>    
...
function AddLayer(){
    ...
    Random += layer_count;
    $("#div-layers").append('<div class="form-group layer-'+Random+'" id="layer"><label>(<a href="javascript:DeleteLayer('+Random+');" style="color:red;">Delete Layer</a>)</label><input class="form-control" type="text" maxlength="250" name="layer[]" placeholder="Slider Layer (Please enter type HTML code)"></div>');
}
// Delete Layer
